        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" href="ShopWaiting">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  " href="../pages/rtl.html">
                            ...
                            <span class="nav-link-text ms-1">Shop List</span>
                        </a>
                    </li>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">proof 1</th>
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">proof 2</th>
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Actions</th>

                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${listshc}" var="listshc">
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex px-2 py-1">

                                                                <div class="d-flex flex-column justify-content-center">
                                                                    <h6 class="mb-0 text-sm">${listshc.getId()}</h6>
                                                                    <input type="hidden" name="id" value="${listshc.getId()}"></input>
                                                        ...
                                                        <td>
                                                            <div class="d-flex px-2 py-1">
                                                                ...
                                                                <div class="d-flex flex-column justify-content-center">
                                                                    <h6 class="mb-0 text-sm ">${listshc.getShopName()}</h6>
                                                                    <input type="hidden" name="Name" value="${listshc.getShopName()}"></input>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="align-middle text-center">
                                                            <p class="text-secondary text-xs font-weight-bold">${listshc.getDateThamGia()}</p>
                                                             <input type="hidden" name="date" value="${listshc.getDateThamGia()}"></input>
                                                        </td>
                                                        <td class="align-middle text-center">
                                                            <p class="text-xs font-weight-bold mb-0">${listshc.getAddress()}</p>
                                                             <input type="hidden" name="address" value="${listshc.getAddress()}"></input>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            ...
                                                            <img src="${listshc.getProof()}" class="avatar avatar-sm me-3" alt="">
                                                            <input type="hidden" name="proof" value="${listshc.getProof()}"></input>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            ...
                                                            <button type="submit" value="reject" name="reject" class="btn btn-link text-danger text-gradient px-3 mb-0" ><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Reject</button>
                                                           

                                                        </td>
                                                <input type="hidden" name="uid" value="${listshc.getuID()}"></input>
