<%-- 
    Document   : ReportOfShop
    Created on : Mar 12, 2024, 10:35:14 AM
    Author     : Admin
--%>
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <a href="getListReportByStatus1?status=1">ĐANG CHỜ SHOP PHẢN HỒI</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                <a href="getListReportByStatus1?status=2">BÁO CÁO ĐƯỢC CHẤP NHẬN</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                <a href="getListReportByStatus1?status=3">BÁO CÁO BỊ BÁC BỎ</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                <a href="getListReportByStatus1?status=4">ĐANG CHỜ XEM XÉT PHẢN HỒI TỪ SHOP</a>
                            </div>
                                        ...
                                        <td>
                                            <form action="detailReportShop">
                                                ...
                                                <button class="btn btn-primary btn-sm edit" type="submit" title="Sửa" data-toggle="modal" data-target="#ModalUP">
                                                    <i class="fas fa-edit"></i> Detail Report
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
