<%-- 
    Document   : NewShippingAddress
    Created on : Feb 25, 2024, 4:30:35 AM
    Author     : Tosaka
--%>
                            ...
                            <div class="shop__cart__table">
                                <form action="shippingaddress" method="post">
                                    <table>                              
                                        <tbody>
                                            <tr>
                                                <th>Name: </th>
                                                <td>
                                                    <input name="fullname" type="text" class="bg-light form-control" placeholder="">
                                                </td>
                                    ...
                                    <tr>
                                        <th>Email: </th>
                                        <td>
                                            <input name="email" type="text" class="bg-light form-control" placeholder="">
                                        </td>
                                    <p style="color: red">${err}</p>
                                    ...
                                    <tr>
                                        <th>Address: </th>
                                        <td>
                                            <input name="address" type="tel" class="bg-light form-control" placeholder="">
                                        </td>
                                    <p style="color: red">${err}</p>
                                    </tr>
                                    <tr>
                                        <th>Phone number: </th>
                                        <td>
                                            <input name="phonenum" type="text" class="bg-light form-control" placeholder="">
                                        </td>
                                    <p style="color: red">${err}</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-sm btn-primary" style="float: right"><b>Add</b></button>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
