...
<html lang="en">
    ...
    <div class="card mb-4">
        <div class="card-header pb-0">
            <h6>Add New Checker And Shipper</h6>
        </div>
        <div class="card-body px-0 pt-0 pb-2">
            <form action="AddCheckerAndShipControl" method="post" enctype="multipart/form-data">
          <div class="form-group">
        <label for="uID">User ID:</label>
        <select class="form-control" id="uID" name="selectedUID" required>
            <option value="">-- Select User ID --</option>
            <c:forEach var="uID" items="${uIDCustomer}">
                <option value="${uID.getuID()}">${uID.getuID()}</option>
            </c:forEach>
        </select>
    </div>
    <div class="form-group">
