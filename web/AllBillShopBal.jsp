<%-- 
    Document   : AllBillShopBal
    Created on : Mar 9, 2024, 3:07:26 PM
    Author     : Admin
--%>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <ul class="list-group">
                    <c:forEach items="${listAllShopBal45}" var="t">
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="pagination__option">
                                    <ul class="pagination justify-content-center float-md-right mb-0">
                                        <c:if test="${tag != 1}">
                                            <li class="page-item"><a href="allBillShopBal?index=${tag-1 }" class="page-link"><i class="fa fa-chevron-left"></i></a></li>
                                                </c:if> 
                                                <c:forEach begin="1" end="${endPage }" var="i">
                                            <li class="${tag==i?"page-item active":"page-item" }"><a href="allBillShopBal?index=${i }" class="page-link">${i }</a></li>
                                            </c:forEach>
                                            <c:if test="${tag != endPage}">
                                            <li class="page-item"><a href="allBillShopBal?index=${tag+1 }" class="page-link"><i class="fa fa-chevron-right"></i></a></li>
                                                </c:if> 
                                    </ul>
                                </div>
                            </div>
