<%-- 
    Document   : IPNUrl2
    Created on : Mar 9, 2024, 5:10:18 PM
    Author     : Admin
--%>
            ...
            if (checkAmount) {
                if (checkOrderStatus) {
                    if ("00".equals(request.getParameter("vnp_ResponseCode"))) { 
                        ...
                        long accountBalance= dao.getAccBalByID(accountID);
                        ...
                        dao.editAccountBalance(accountID, accountBalance-vnp_Amount);
                        dao.insertAccountBalance1(accountID, vnp_Amount, vnp_TxnRef);        
                        
                                
                        response.sendRedirect("accountBalance");
