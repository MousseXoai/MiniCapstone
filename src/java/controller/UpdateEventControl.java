 ...
 * @author dell
 */
public class UpdateEventControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a == null || a.getIsSell() != 1) {
            ...
            List<Event> getEventByEventID = dao.getEventByEventID(eventId);
            
        
            request.setAttribute("getEventByEventID", getEventByEventID);
