 ...
 * @author Tosaka
 */
public class CustomerRefundControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CustomerRefundControl</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CustomerRefundControl at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (a == null) {
            ...
            ArrayList<Reason> reason = dao.getAllReason1();
            ...
            request.getRequestDispatcher("RefundProduct.jsp").forward(request, response);
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (a == null) {
            ...
            dao.insertRefundReason(Integer.parseInt(invoiceID), Integer.parseInt(reason_option), note);
            dao.traSanPham(Integer.parseInt(invoiceID));
